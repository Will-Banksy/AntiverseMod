...
public static class Helper {
	...
	public static readonly Vector2[] VecArrayCross = { new Vector2(1, 1), new Vector2(1, -1), new Vector2(-1, -1), new Vector2(-1, 1) };
	public static readonly Vector2[] VecArrayPlus = { new Vector2(1, 0), new Vector2(0, -1), new Vector2(-1, 0), new Vector2(0, 1) };
