...
//The 3 below are uncommon ones that you need for making multi tiles
...
namespace AntiverseMod.Tiles.Crafting
{
    public class DemonicAltar : ModTile //Multi Tile
	{
		...
		public override void KillMultiTile(int i, int j, int frameX, int frameY)
		{
			...
			Item.NewItem(i * 16, j * 16, 48, 32, ModContent.ItemType<DemonicAltarItem>());
		}
